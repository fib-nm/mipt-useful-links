...
## Pull request
Для изменения названия или описания ресурса, а также ссылки на него, делайте pull request.

## Issue
Issue можно использовать чтобы:
1. Сообщить о нерабочей ссылке.
2. Попросить добавить ресурс и ссылку на него в список.

При написании issue, используйте подходящий label.
