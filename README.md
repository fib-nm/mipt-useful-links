...
- Дискретный анализ
- Лабы по общей физике (1-5 семестры)
- Математический анализ
- Общая физика (1-5 семестры)
- C
- C++
- Линейная алгебра
- Многомерный анализ, интегралы и ряды
- Теорвер
- Аналитическая механика (3-4 семестры)
- Дифференциальные уравнения (3-4 семестры)
- Кратные интегралы и теория поля
- Лабы по РТ (3-4 семестры)
- Гармонический анализ
- Аналоговая электроника
- Вычислительная математика (5-6 семестры)
- ГКЭ по физике
- Компьютерные сети (5-6 семестры)
- Линейные методы в РТ
- ТФКП
- Квантовая теория поля
- ГКЭ по математике
- Дискретные преобразования сигналов
- Дискретные случайные процессы
- Квантовая механика (6-7 семестры)
